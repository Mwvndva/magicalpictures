              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-zinc-950 border border-gray-700 rounded-md focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-white placeholder-gray-400"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-zinc-950 border border-gray-700 rounded-md focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-white"
                    required
                  >
